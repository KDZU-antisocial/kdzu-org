...
<PhotoGrid 
  photos={[
    ...
    { 
      ...
      caption: "These beheaded wooden tower legs indicate that the newer metal overhead power line towers follow the same route."
    }
  ]}
  columns={2}
/>

After spending many hours acclimating the the Arroyo wash area and staring at maps from the 1980s we found a site that looks promising. 
